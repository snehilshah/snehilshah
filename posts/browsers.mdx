...
<ImageBox link='/posts/browsers/zen.avif' text='Zen Browser' />

What I like is the fact that they are not trying to re-invent the wheel and build a new browser from the ground up like [LadyBird](https://ladybird.org). Rather, They're addressing features users have long desired.

...
date: 'Aug 7, 2023'
cover_image: '/posts/windows/logo.png'
...
One such feature is the **package manager** like `apt` or `yum`.

## The Solution

Windows still has some great features that can help you to boost your productivity and make your experience better.
...
Here we tackled the problem of installing and updating apps on windows. We used winget to automate the process and make it easier. Hence, we can use more time towards productivity.

<ImageBox link='/posts/windows/wingetSoftwares.png' text='My Softwares Folder' />

No more searching for setup fils locally, I personally have faced this problem. I used to download setup files and store them locally. But now I can just use winget to install and update apps.
Below you can see how I managed my files which was eating away almost 9GB of my disk space. Now I just use <Standout text='winget' /> 🙂

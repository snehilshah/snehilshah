...
Searching for setup files locally, I personally have faced this problem. I used to download setup files and store them locally. But now I can just use winget to install and update apps.
Below you can see how I used to manage my files which was eating away almost 9GB of my disk space. Now I just use <Standout text='winget' /> 🙂
...
Here we tackled the problem of installing and updating apps on windows. We will use winget to automate the process and make it easier. Hence, we can use more time towards productivity.
